...
package deltax.gui.base {
    ...
    public class WindowCreateParam implements ReferencedObject {
		...
		private var m_pixelArea:ByteArray;
		...
		public function get pixelArea():ByteArray
		{
			return m_pixelArea;
		}
		
		public function set pixelArea(value:ByteArray):void
		{
			m_pixelArea = value;
		}
        ...
        public function set style(_arg1:uint):void{
            this.checkWritable();
            this.m_style = _arg1;
			trace("style=======================544545454",this.m_style,this.id);
        }
        ...
        public function load(_arg1:ByteArray, _arg2:uint):void{
			...
			trace("style=======================0000",this.m_style,this.id);
			...
			//
			//像素检测区域    by  lrw
//			if((WindowStyle.MOUSE_CHECK_ON_PIXEL&m_style)!=0)
//			{
//				if(_arg1.bytesAvailable)
//				{
//					var ll:uint = _arg1.readUnsignedInt();
////					trace("read len================",ll);
//					if(m_pixelArea == null)
//					{
//						m_pixelArea = new ByteArray();
//						m_pixelArea.endian = Endian.LITTLE_ENDIAN;
//					}
//					m_pixelArea.position = 0;
//					var pos:uint = _arg1.position;
//					_arg1.readBytes(m_pixelArea,0,ll);
////					m_pixelArea.position = 0;
////					if(m_pixelArea)
////					{
////						m_pixelArea.position = 0;
////						var str:String = "";
////						var ii:uint;
////						while(m_pixelArea.bytesAvailable)
////						{
////							
////							if(ii>0&&(ii%159==0))
////							{
////								str+="\n"+m_pixelArea.readUnsignedByte();
////							}else
////							{
////								str+=m_pixelArea.readUnsignedByte();
////							}
////							ii++;
////						}
...
//			}
        ...
        public function copyFrom(_arg1:WindowCreateParam):void{
			...
			trace("style=======================55555555555",this.m_style,this.id);
            this.m_x = _arg1.m_x;
            this.m_y = _arg1.m_y;
			...
			this.m_pixelArea = _arg1.pixelArea;
        }
		...
		public function write(data:ByteArray):void{
			...
			//写入像素检测区域    by  lrw
			if((m_style &WindowStyle.MOUSE_CHECK_ON_PIXEL)!=0)
			{
				if(m_pixelArea&&m_pixelArea.length>0)
				{
					m_pixelArea.position = 0;
					var l:uint = m_pixelArea.bytesAvailable;
					data.writeUnsignedInt(l);
					var p:uint = data.position;
					data.writeBytes(m_pixelArea,0,m_pixelArea.bytesAvailable);
//					trace("write len===============",l);
				}
			}
		}
