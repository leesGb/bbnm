...
package deltax.common.resource {
    ...
    public class CommonFileHeader {
        ...
        public static const eFT_GammaAdvanceMesh:uint = Util.makeDwordFromString("a", "m", "s", "");
        public static const eFT_GammaAniStruct:uint = Util.makeDwordFromString("a", "n", "s", "");
        public static const eFT_GammaAniFrame:uint = Util.makeDwordFromString("a", "n", "f", "");
        public static const eFT_GammaMaterial:uint = Util.makeDwordFromString("m", "t", "r", "");
        public static const eFT_GammaTexture:uint = Util.makeDwordFromString("t", "e", "x", "");
        public static const eFT_GammaEffect:uint = Util.makeDwordFromString("e", "f", "t", "");
        public static const eFT_GammaShader:uint = Util.makeDwordFromString("g", "f", "x", "");
        public static const eFT_GammaMap:uint = Util.makeDwordFromString("m", "a", "p", "");
        public static const eFT_GammaGUI:uint = Util.makeDwordFromString("g", "u", "i", "");
